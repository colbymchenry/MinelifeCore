...

{
        ...
        for( MethodNode method : cn.methods ) {
            ...
            if( method.visibleAnnotations != null ) {
                ...
                for( AnnotationNode annotation : method.visibleAnnotations ) {
                    ...
                    if( annotation.desc.equals("Lcom/minelife/core/util/ASMOverride;") ) {
                        ...
                        if( !method.name.equals(asmMethod.name) ) {
                            ...
                            MinelifeCoreLoadingPlugin.MOD_LOG.log(Level.FATAL, String.format(err, asmMethod.name, cn.name, method.name));
                            ...
                            MinelifeCoreLoadingPlugin.MOD_LOG.log(Level.FATAL, String.format(err, asmMethod.name, asmMethod.desc, cn.name, method.desc));
                            ...
                            MinelifeCoreLoadingPlugin.MOD_LOG.log(Level.FATAL, String.format(err, getAccessLevelName(method.access), asmMethod.name, cn.name,
                            ...
                            if( !classPkg.equals(ownerPkg) ) {
                                ...
                                MinelifeCoreLoadingPlugin.MOD_LOG.log(Level.FATAL, String.format(err, method.name, ownerPkg, cn.name, classPkg));
                            ...
                            MinelifeCoreLoadingPlugin.MOD_LOG.log(Level.WARN, String.format("The Method %s is marked as deprecated! It is most likely that the method is " +
    ...
    private static MethodNode getSignature(String method) {
        ...
        if( !mtch.find() ) {
            ...
            throw new RuntimeException("Minelife-Method signature invalid!");
